...
double envergadura_das_asas, string pais_origem):Ave(id, classe, m_nome_cientifico, sexo, tamanho, dieta,
veterinario, tratador, m_nome_batismo, tamanho_do_bico_cm, envergadura_das_asas), AnimalExotico(pais_origem)
{/*empty*/}
AveExotico::~AveExotico() { /* empty */ }