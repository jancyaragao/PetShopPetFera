...
string pais_origem):Mamifero(id, classe, m_nome_cientifico, sexo, tamanho, dieta, veterinario,
tratador, m_nome_batismo, m_cor_pelo),AnimalExotico(pais_origem){/*empty*/}
MamiferoExotico::~MamiferoExotico() { /* empty */ }