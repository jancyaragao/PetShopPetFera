...
void cadastramento_usuario::on_buttonBox_accepted()
{
    ...
    QMessageBox::critical(this,"Problemas", nome_a_ser_cadastrado+cpf_a_ser_cadastrado+idade+funcao+especialidade+tipo_sanguineo_a_ser_cadastrado+codigo_crmv_a_ser_cadastrado+nivel_de_seg);
}
//fazer um set para enviar os dados para telalogin
