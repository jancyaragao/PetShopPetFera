...
string uf_origem, string autorizacao):Anfibio(id, classe, nome_cientifico, sexo, tamanho, dieta,
id_veterinario, id_tratador, nome_batismo, total_de_mudas), AnimalNativo(uf_origem, autorizacao){/*empty*/}
AnfibioNativo::~AnfibioNativo() {/*empty*/}