...
string tipo_veneno, string pais_origem):Reptil(id, classe, m_nome_cientifico, sexo, tamanho, dieta,
veterinario, tratador, m_nome_batismo, m_venenoso, tipo_veneno), AnimalExotico(pais_origem){/*empty*/}
ReptilExotico::~ReptilExotico() { /* empty */ }